...
def get_hover_template(first_line, mode):
    '''
    ...
    first_line = f"<span style='font-family:Grenze Gotisch; font-size:24px; color:black;'>{first_line}</span><br>"
    second_line = "%{y} lines" if mode == MODES['count'] else "%{y:.2f}% of lines"
